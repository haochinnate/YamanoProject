...
export const CREATE_TRIMLEVEL = 'CREATE_TRIMLEVEL';
export const FETCH_TRIMLEVELS = 'FETCH_TRIMLEVELS';
export const FETCH_TRIMLEVEL = 'FETCH_TRIMLEVEL';
export const DELETE_TRIMLEVEL = 'DELETE_TRIMLEVEL';
export const EDIT_TRIMLEVEL = 'EDIT_TRIMLEVEL';
